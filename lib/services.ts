...
export const services: ServiceData[] = [
  ...
  },
  {
    ...
    subServices: [
      ...
      { title: 'Bridge Finance', description: 'Short-term capital to cover the gap while you await payment or long-term funding.' },
      { title: 'Project Finance & Syndication', description: 'Structured and syndicated funding solutions for large-scale contracts and projects.' },
    ],
  ...
  },
  {
    ...
    subServices: [
      ...
      { title: 'Industrial Machinery', description: 'Fund manufacturing equipment, generators, and specialized production machinery.' },
      { title: 'IT & Laptops', description: 'Equip your team with laptops, servers, and IT infrastructure without a large upfront cost.' },
    ],
  ...
  },
  {
    ...
    subServices: [
      ...
      { title: 'Corporate Invoice Discounting', description: 'Get advances on invoices issued to reputable corporate clients across Nigeria.' },
      { title: 'Government Invoice Discounting', description: 'Access funds against invoices owed by government parastatals and agencies.' },
      { title: 'Export Invoice Financing', description: 'Unlock cash tied up in invoices from your export clients while you await payment.' },
      { title: 'Supply Chain Financing', description: 'Extend working capital across your supply chain by financing invoices from trusted buyers.' },
    ],
  ...
  },
  {
    ...
    subServices: [
      ...
      { title: 'Flexible Savings Plan', description: 'Save and withdraw anytime while still earning competitive returns.' },
      { title: 'Wealth & Retirement Plan', description: 'A long-term structured plan to help you build wealth for retirement.' },
    ],
